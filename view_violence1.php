...
<title>Violence/Murder case record</title>
                  ...
                  <div class="col-md-8">
                     <div class="collapse navbar-collapse" id="min_navbar">
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <li class="dropdown submenu">
                              <a href="view_theft1.php" class="">Theft Cases</a>
                           </li>
                           <li class="dropdown submenu">
         ...
         <thead class="blue lighten-2">
            <h6><tr>
              ...
              <th>Full Name</th>
                ...
                <th>Murder/Violence</th>
              
                <th>Damages/who is murdered?</th>
         ...
         <div class="book_now_aera ">
            <div class="container wow fadeInUp">
               <div class="row book_now">
                  <div class="col-md-4">
                     <div class="">
                        <a class=" logo-biss" href="home.php"> Eldoret police case data regisrty</a>
                     </div>
                  ...
                  <div class="col-md-3">
                     ...
                     <ul class="footer-menu">
                        ...
                        <li><a href="view_theft1.php">Theft Cases </a> </li>
                        <li><a href=""></a> </li>
                        <li><a href="view_land1.php">Land Cases  </a> </li>
