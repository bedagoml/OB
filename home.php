...
$query = $DBcon->query("SELECT * FROM duty WHERE user_id=".$_SESSION['userSession']);
   ...
   <body>
      <div class="bg-banner-img clip-ellipse">
         <div class="ovrllay">
                     ...
                     <div class="collapse navbar-collapse" id="min_navbar">
                        <ul class="nav navbar-nav navbar-right">
                           <li class="dropdown submenu ">
                            ...
                            <li class="dropdown submenu ">
                              <a href="home.php" >View Cases</a>
                              <i class="icon"></i>
                              <i class="icons"></i>
                              <ul class="dropdown-menu">
                                 <li><a href="view_theft1.php">Theft</a></li>
                                  <li><a href="view_violence1.php"> Violence/Murder</a> </li>
                                   <li><a href="view_land1.php"> Land</a> </li>
            ...
            <li><a href="logout1.php?logout"><span class="glyphicon glyphicon-log-out"></span>&nbsp; Logout</a></li>
          </ul>
                        </ul>
                     </div>
                     <!-- /.navbar-collapse -->
                     ...
                     <div class="who_we_area col-md-4 col-sm-6 wow fadeInUp">
                        <div class="service-1 green-after"">
                           ...
                           <div class="button-div">
                              <a href="record_theft.php" class="button-s"> Register Case   </a>
                           </div>
                        </div>
                     </div>
                     <div class="who_we_area col-md-4 col-sm-6  wow fadeInUp">
                        <div class="service-1 pink-after">
                           ...
                           <div class="button-div">
                              <a href="record_violence.php" class="button-s"> Register case   </a>
                           </div>
                        </div>
                     </div>
                     <div class="who_we_area col-md-4 col-sm-6  wow fadeInUp">
                        <div class="service-1 purple-after">
                           ...
                           <div class="button-div">
                              <a href="record_land.php" class="button-s"> Register Case   </a>
                           </div>
                        </div>
                     </div>
                     <!--#End about-text  --> 
         ...
         <div class="book_now_aera ">
            <div class="container wow fadeInUp">
               <div class="row book_now">
                  <div class="col-md-4">
                     <div class="">
                        <a class=" logo-biss" href="home.php"> Eldoret police case data registry</a>
                     </div>
                 ...
                 <div class="col-md-3">
                     ...
                     <ul class="footer-menu">
                       ...
                       <li>
                              <a href="view_violence1.php" class="">Murder/Violence cases</a>
                           </li>
                           <li>
                              <a href="view_land1.php" class=""> Land Cases</a>
                           </li>
                     </ul>
                  </div>
                  <div class="col-md-4">
