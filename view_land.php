               ...
               <div class="container m-s">
                  ...
                  <div class="col-md-4 ">
                     <div class="navbar-header">
                        ...
                        <a class="navbar-brand logo-biss" href="home1.php"> Eldoret Police</a>
                     </div>
                  </div>
                  ...
                  <div class="col-md-8">
                     <div class="collapse navbar-collapse" id="min_navbar">
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <li class="dropdown submenu">
                              <a href="view_violence.php" class=""> Violence/Murder Cases</a>
                           </li>
         ...
         <div class="book_now_aera ">
            <div class="container wow fadeInUp">
               <div class="row book_now">
                  <div class="col-md-4">
                     <div class="">
                        <a class=" logo-biss" href="home1.php"> Eldoret police case data registry</a>
                     </div>
                  ...
                  <div class="col-md-3">
                     ...
                     <ul class="footer-menu">
                        ...
                        <li><a href="view_violence.php" class=""> Violence/Murder Cases</a></li>
                     
                        <li><a href="view_theft.php" class="">Theft Cases</a></li>
