...
<html lang="en">
   <head>
      ...
      <title>Eldoret Police station  </title>
      <!-- Favicon -->
      <!-- Bootstrap CSS -->
               ...
               <div class="container m-s">
                  ...
                  <div class="col-md-4 ">
                     <div class="navbar-header">
                        ...
                        <a class="navbar-brand logo-biss" href="home.php"> Eldoret Police Station </a>
                     </div>
                  </div>
                  ...
                  <div class="col-md-8">
                     <div class="collapse navbar-collapse" id="min_navbar">
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <li class="dropdown submenu">
                              <a href="register.php" class="">Register Police</a>
                           </li>
                          <li class="dropdown submenu ">
                              <a href="index.html" >View Cases</a>
                              <i class="icon"></i>
                              <i class="icons"></i>
                              <ul class="dropdown-menu">
                                 <li><a href="view_theft.php">Theft</a></li>
                                  <li><a href="view_violence.php"> Violence/Murder</a> </li>
                                   <li><a href="view_land.php"> Land</a> </li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class="icon-user"></span>&nbsp; <?php echo $userRow['username']; ?></a></li>
            <li><a href="logout.php?logout"><span class="icon-log-out"></span>&nbsp; Logout</a></li>
          </ul>
                        </ul>
                     </div>
                     <!-- /.navbar-collapse -->
                  ...
                  <div class="row">
                     ...
                     <div id="banner-text" class="col-md-12 text-c  ">
                        <div class="left-borders">
                           <p  class="banner-text wow fadeInUp main-h3" data-wow-delay="0.8s"> one simple goal : </p>
                           <h5 class="wow fadeInUp main-h" data-wow-delay="0.2s" >To avoid bulky book work and space consumption keeping the large books</h5>
                        </div>
                        <p class="banner-text wow fadeInUp main-h3" data-wow-delay="0.8s">Police digital case complains and recordes <br></p>
                     </div>
                     <!-- /#banner-text End -->
                  </div>
                  <div class="row mt-100 p-0">
                     ...
                     <div class="who_we_area col-md-4 col-sm-6 wow fadeInUp">
                        <div class="service-1 green-after"">
                           ...
                           <h2 class="unify"> Theft  &<br>CASES </h2>
                           <div class="button-div">
                              <a href="view_theft.php" class="button-s"> View Cases   </a>
                           </div>
                        </div>
                     </div>
                     <div class="who_we_area col-md-4 col-sm-6  wow fadeInUp">
                        <div class="service-1 pink-after">
                           ...
                           <h2 class="unify"> Violence & Murder <br>CASES </h2>
                           <div class="button-div">
                              <a href="view_violence.php" class="button-s"> View cases   </a>
                           </div>
                        </div>
                     </div>
                     <div class="who_we_area col-md-4 col-sm-6  wow fadeInUp">
                        <div class="service-1 purple-after">
                           ...
                           <h2 class="unify"> Land<br>CASES </h2>
                           <div class="button-div">
                              <a href="view_land.php" class="button-s"> View Cases </a>
                           </div>
                        </div>
                     </div>
                     <!--#End about-text  --> 
         ...
         <div class="book_now_aera ">
            <div class="container wow fadeInUp">
               <div class="row book_now">
                  <div class="col-md-4">
                     <div class="">
                        <a class=" logo-biss" href="index.html"> Eldoret police case data registry</a>
                     </div>
