                  ...
                  <div class="col-md-8">
                     <div class="collapse navbar-collapse" id="min_navbar">
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <li class="dropdown submenu">
                              <a href="view_violence1.php" class=""> Violence/Murder Cases</a>
                           </li>
               ...
               <div class="row book_now">
                  ...
                  <div class="col-md-3">
                     ...
                     <ul class="footer-menu">
                        ...
                        <li><a href="view_violence1.php" class=""> Violence/Murder Cases</a></li>
                     
                        <li><a href="view_theft1.php" class="">Theft Cases</a></li>
